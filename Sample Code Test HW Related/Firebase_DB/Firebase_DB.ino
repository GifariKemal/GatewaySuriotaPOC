...
#define WIZNET_RESET_PIN 3  // Connect W5500 Reset pin to GPIO 26 of ESP32 (-1 for no reset pin assigned)
#define WIZNET_CS_PIN 48    // Connect W5500 CS pin to GPIO 5 of ESP32
#define WIZNET_MISO_PIN 21  // Connect W5500 MISO pin to GPIO 19 of ESP32
#define WIZNET_MOSI_PIN 14  // Connect W5500 MOSI pin to GPIO 23 of ESP32
#define WIZNET_SCLK_PIN 47  // Connect W5500 SCLK pin to GPIO 18 of ESP32
...
void setup() 
  ...
  fbdo.setEthernetClient(&Udp, Eth_MAC, WIZNET_CS_PIN, WIZNET_RESET_PIN);  // The staIP can be assigned to the fifth param
