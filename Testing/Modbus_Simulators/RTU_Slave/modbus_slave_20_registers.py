...
=============================================================================
Description:
    Simulates a Modbus RTU slave with 20 Input Registers
    ...
    Registers (20 Input Registers - Function Code 4):
    - Addresses: 0 to 19
...
Usage:
    ...
    3. Run: python modbus_slave_20_registers.py
...
def print_banner():
    ...
    print(f"  SRT-MGATE-1210 Testing - 20 Input Registers")
    print("="*70)
