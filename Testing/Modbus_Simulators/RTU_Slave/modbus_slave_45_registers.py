...
=============================================================================
Description:
    Simulates a Modbus RTU slave with 45 Input Registers
    ...
    Registers (45 Input Registers - Function Code 4):
    - Addresses: 0 to 44
...
Usage:
    ...
    3. Run: python modbus_slave_45_registers.py
...
def print_banner():
    ...
    print(f"  SRT-MGATE-1210 Testing - 45 Input Registers")
    print("="*70)
