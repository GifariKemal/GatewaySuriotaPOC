...
"""
=============================================================================
Modbus RTU Slave Simulator Generator (Enhanced v2.0)
=============================================================================
Generates RTU slave simulators with:
  - Enhanced terminal UI with colors
  - Shared simulator_common module
...
SENSOR_TYPES = [
    {"name": "Temperature", "unit": "degC", "min": 20, "max": 35, "initial": 25},
    ...
    {"name": "Power", "unit": "W", "min": 0, "max": 5000, "initial": 1000},
    {"name": "Frequency", "unit": "Hz", "min": 48, "max": 52, "initial": 50},
    {"name": "PowerFactor", "unit": "%", "min": 0, "max": 100, "initial": 95},
    {"name": "Energy", "unit": "kWh", "min": 0, "max": 9999, "initial": 100},
    {"name": "Flow", "unit": "L/min", "min": 0, "max": 100, "initial": 50},
]

TEMPLATE = '''#!/usr/bin/env python3
"""
=============================================================================
Modbus RTU Slave Simulator - {num_regs} Input Registers
=============================================================================
...
def generate_programs():
    ...
    for num_regs in register_counts:
        print(f"  Generating modbus_slave_{num_regs}_registers.py...")
    ...
    print()
    print("  [OK] All RTU slave simulators generated!")
    print()
...
if __name__ == "__main__":
    print()
    print("=" * 60)
    print("  Modbus RTU Slave Simulator Generator v2.0")
    print("=" * 60)
    print("  Enhanced with:")
    print("    - Colored terminal output")
    print("    - pymodbus 2.x/3.x compatibility")
    print("    - Shared simulator_common module")
    print("    - Expanded sensor types")
    print("=" * 60)
