...
=============================================================================
Description:
    Simulates a Modbus RTU slave with 10 Input Registers
    ...
    Registers (10 Input Registers - Function Code 4):
    - Addresses: 0 to 9
...
Usage:
    ...
    3. Run: python modbus_slave_10_registers.py
...
def print_banner():
    ...
    print(f"  SRT-MGATE-1210 Testing - 10 Input Registers")
    print("="*70)
