...
=============================================================================
Description:
    Simulates a Modbus RTU slave with 30 Input Registers
    ...
    Registers (30 Input Registers - Function Code 4):
    - Addresses: 0 to 29
...
Usage:
    ...
    3. Run: python modbus_slave_30_registers.py
...
def print_banner():
    ...
    print(f"  SRT-MGATE-1210 Testing - 30 Input Registers")
    print("="*70)
