...
"""
=============================================================================
Modbus RTU Slave Simulator - 15 Input Registers
=============================================================================
Description:
    Simulates a Modbus RTU slave with 15 Input Registers
    ...
    Registers (15 Input Registers - Function Code 4):
    - Addresses: 0 to 14
...
Usage:
    ...
    3. Run: python modbus_slave_15_registers.py
...
def print_banner():
    ...
    print(f"  SRT-MGATE-1210 Testing - 15 Input Registers")
    print("="*70)
