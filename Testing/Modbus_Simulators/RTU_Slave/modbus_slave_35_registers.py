...
=============================================================================
Description:
    Simulates a Modbus RTU slave with 35 Input Registers
    ...
    Registers (35 Input Registers - Function Code 4):
    - Addresses: 0 to 34
...
Usage:
    ...
    3. Run: python modbus_slave_35_registers.py
...
def print_banner():
    ...
    print(f"  SRT-MGATE-1210 Testing - 35 Input Registers")
    print("="*70)
