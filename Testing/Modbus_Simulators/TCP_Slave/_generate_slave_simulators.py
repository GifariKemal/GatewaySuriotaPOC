...
"""
=============================================================================
Modbus TCP Slave Simulator Generator (Enhanced v2.0)
=============================================================================
Generates TCP slave simulators with:
...
def generate_programs():
    ...
    print()
    print("  [OK] All TCP slave simulators generated!")
    print()
...
if __name__ == "__main__":
    print()
    print("=" * 60)
    print("  Modbus TCP Slave Simulator Generator v2.0")
    print("=" * 60)
    print("  Enhanced with:")
