...
"""
=============================================================================
Modbus TCP Slave Simulator - 20 Input Registers
=============================================================================
Description:
...
Usage:
    ...
    2. Run: python modbus_slave_20_registers.py
...
# =============================================================================
# Configuration (Match with Device_Testing/create_device_20_registers.py)
# =============================================================================
...
NUM_REGISTERS = 20          # 20 Input Registers

# Register definitions (matching create_device_20_registers.py)
REGISTER_INFO = {
...
def print_banner():
    ...
    print("  SRT-MGATE-1210 Testing - 20 Input Registers")
    print("="*70)
...
if __name__ == "__main__":
    ...
    print("  Device_Testing/create_device_20_registers.py")
    print("\n" + "="*70 + "\n")
