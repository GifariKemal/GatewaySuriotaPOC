...
"""
=============================================================================
Modbus TCP Slave Simulator - 25 Input Registers
=============================================================================
Description:
...
Usage:
    ...
    2. Run: python modbus_slave_25_registers.py
...
# =============================================================================
# Configuration (Match with Device_Testing/create_device_25_registers.py)
# =============================================================================
...
NUM_REGISTERS = 25          # 25 Input Registers

# Register definitions (matching create_device_25_registers.py)
REGISTER_INFO = {
...
def print_banner():
    ...
    print("  SRT-MGATE-1210 Testing - 25 Input Registers")
    print("="*70)
...
if __name__ == "__main__":
    ...
    print("  Device_Testing/create_device_25_registers.py")
    print("\n" + "="*70 + "\n")
