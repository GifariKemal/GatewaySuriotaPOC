...
"""
=============================================================================
Modbus TCP Slave Simulator - 30 Input Registers
=============================================================================
Description:
...
Usage:
    ...
    2. Run: python modbus_slave_30_registers.py
...
# =============================================================================
# Configuration (Match with Device_Testing/create_device_30_registers.py)
# =============================================================================
...
NUM_REGISTERS = 30          # 30 Input Registers

# Register definitions (matching create_device_30_registers.py)
REGISTER_INFO = {
...
def print_banner():
    ...
    print("  SRT-MGATE-1210 Testing - 30 Input Registers")
    print("="*70)
...
if __name__ == "__main__":
    ...
    print("  Device_Testing/create_device_30_registers.py")
    print("\n" + "="*70 + "\n")
