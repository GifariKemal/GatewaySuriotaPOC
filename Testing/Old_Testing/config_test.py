        ...
        await self.send_command(
            {
                ...
                "config": {
                    ...
                    "logging_config": {"logging_ret": "1w", "logging_interval": "10m"},
                },
            }
        )
        ...
        await self.send_command(
            {
                ...
                "config": {
                    "communication": {
                        ...
                        "mac_address": "00:1A:2B:3C:4D:5E",
                        "wifi": {"ssid": "MQTTNetwork", "password": "MQTTPassword"},
                    },
                    "protocol": "mqtt",
                    "data_interval": {"value": 5000, "unit": "ms"},
                    "mqtt_config": {
                        "enabled": True,
                    ...
                    "logging_config": {"logging_ret": "3m", "logging_interval": "30m"},
                },
            }
        )
        ...
        await self.send_command(
            {
                ...
                "config": {
                    ...
                    "logging_config": {"logging_ret": "1m", "logging_interval": "5m"},
                },
            }
        )
