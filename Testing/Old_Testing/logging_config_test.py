...
class LoggingConfigClient:
    ...
    async def read_logging_config(self):
        ...
        await self.send_command({"op": "read", "type": "logging_config"})
        ...
        await self.send_command(
            {
                "op": "update",
                "type": "logging_config",
                "config": {"logging_ret": "1w", "logging_interval": "5m"},
            }
        )
        ...
        await self.send_command(
            {
                "op": "update",
                "type": "logging_config",
                "config": {"logging_ret": "1m", "logging_interval": "10m"},
            }
        )
        ...
        await self.send_command(
            {
                "op": "update",
                "type": "logging_config",
                "config": {"logging_ret": "3m", "logging_interval": "30m"},
            }
        )
