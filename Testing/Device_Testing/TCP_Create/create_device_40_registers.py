...
Create 1 TCP Device + 40 Registers
=============================================================================
...
Registers: 40 Input Registers (INT16, Function Code 4)

Dependencies:
  pip install bleak colorama

IMPORTANT: Start the Modbus TCP Slave Simulator BEFORE running this script!
  Location: Testing/Modbus_Simulators/TCP_Slave/modbus_slave_40_registers.py
...
# =============================================================================
NUM_REGISTERS = 40
DEVICE_NAME = "TCP_Device_40_Regs"
DEVICE_CONFIG = {
