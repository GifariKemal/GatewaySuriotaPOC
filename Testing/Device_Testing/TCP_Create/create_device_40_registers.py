...
class DeviceCreationClient:
    ...
    async def create_device_and_registers(self):
        print("\n" + "="*70)
        print("  SRT-MGATE-1210 TESTING: CREATE 1 DEVICE + 40 REGISTERS")
        print("="*70)
        ...
        await self.send_command(device_config, "Creating TCP Device: TCP_Device_40_Regs")
        ...
        print("  SUMMARY")
        print("="*70)
        print(f"Device Name:      TCP_Device_40_Regs")
