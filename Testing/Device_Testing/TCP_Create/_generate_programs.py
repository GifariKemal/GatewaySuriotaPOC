#!/usr/bin/env python3
"""
Script to generate device creation programs for different register counts
"""
...
Create 1 TCP Device + {num_regs} Registers
=============================================================================
...
class DeviceCreationClient:
    ...
    async def create_device_and_registers(self):
        print("\\n" + "="*70)
        print("  SRT-MGATE-1210 TESTING: CREATE 1 DEVICE + {num_regs} REGISTERS")
        print("="*70)
        ...
        device_config = {{
            ...
            "device_id": None,
            "config": {{
                "device_name": "TCP_Device_{num_regs}_Regs",
                "protocol": "TCP",
                "slave_id": 1,
                "timeout": 3000,
                "retry_count": 3,
        ...
        await self.send_command(device_config, "Creating TCP Device: TCP_Device_{num_regs}_Regs")
...
{registers_list}
        ...
        print("  SUMMARY")
        print("="*70)
        print(f"Device Name:      TCP_Device_{num_regs}_Regs")
...
def generate_programs():
    """Generate programs for different register counts"""

    for num_regs in [15, 20, 25, 30, 35, 40, 45, 50]:
        print(f"Generating program for {num_regs} registers...")
    ...
    print("\\n[OK] All programs created successfully!")
