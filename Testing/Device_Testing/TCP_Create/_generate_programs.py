...
"""
=============================================================================
TCP Device Creation Programs Generator (Enhanced v2.0)
=============================================================================
Generates TCP device creation scripts with:
...
IMPORTANT: Start the Modbus TCP Slave Simulator BEFORE running this script!
  Location: Testing/Modbus_Simulators/TCP_Slave/modbus_slave_{num_regs}_registers.py
...
def generate_programs():
    ...
    for num_regs in register_counts:
        ...
        # Generate registers list (Temperature Zones)
        registers_lines = []
    ...
    print()
    print("  [OK] All TCP programs generated!")
    print()
...
if __name__ == "__main__":
    print()
    print("=" * 60)
    print("  TCP Device Creation Programs Generator v2.0")
    print("=" * 60)
    print("  Enhanced with:")
