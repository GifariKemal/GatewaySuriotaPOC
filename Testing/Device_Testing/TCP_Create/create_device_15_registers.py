...
Create 1 TCP Device + 15 Registers
=============================================================================
...
Registers: 15 Input Registers (INT16, Function Code 4)

Dependencies:
  pip install bleak colorama

IMPORTANT: Start the Modbus TCP Slave Simulator BEFORE running this script!
  Location: Testing/Modbus_Simulators/TCP_Slave/modbus_slave_15_registers.py
...
# =============================================================================
NUM_REGISTERS = 15
DEVICE_NAME = "TCP_Device_15_Regs"
DEVICE_CONFIG = {
