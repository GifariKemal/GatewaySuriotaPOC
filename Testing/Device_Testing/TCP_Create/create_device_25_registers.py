...
Create 1 TCP Device + 25 Registers
=============================================================================
...
Registers: 25 Input Registers (INT16, Function Code 4)

Dependencies:
  pip install bleak colorama

IMPORTANT: Start the Modbus TCP Slave Simulator BEFORE running this script!
  Location: Testing/Modbus_Simulators/TCP_Slave/modbus_slave_25_registers.py
...
# =============================================================================
NUM_REGISTERS = 25
DEVICE_NAME = "TCP_Device_25_Regs"
DEVICE_CONFIG = {
