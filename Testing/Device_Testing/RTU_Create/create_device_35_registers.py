...
Create 1 RTU Device + 35 Registers
=============================================================================
Device: RTU Device (COM8, 9600 baud, 8N1)
Slave ID: 1
Registers: 35 Input Registers (INT16)
=============================================================================
...
class DeviceCreationClient:
    ...
    async def create_device_and_registers(self):
        print("\n" + "="*70)
        print("  SRT-MGATE-1210 TESTING: CREATE 1 RTU DEVICE + 35 REGISTERS")
        print("="*70)
        ...
        device_config = {
            ...
            "device_id": None,
            "config": {
                "device_name": "RTU_Device_35_Regs",
                "protocol": "RTU",
                "slave_id": 1,
                "timeout": 5000,
                "retry_count": 3,
        ...
        await self.send_command(device_config, "Creating RTU Device: RTU_Device_35_Regs")
        ...
        print(f"\n>>> STEP 2: Creating 35 Registers for Device ID: {self.device_id}")
        ...
        for idx, reg in enumerate(registers, 1):
            ...
            await self.send_command(
                register_config,
                f"Creating Register {idx}/35: {reg['name']} (Address: {reg['address']})"
            )
        ...
        print("  SUMMARY")
        print("="*70)
        print(f"Device Name:      RTU_Device_35_Regs")
...
async def main():
    ...
    try:
        print("\n" + "="*70)
        print("  SRT-MGATE-1210 Firmware Testing - RTU Mode (35 Registers)")
        ...
        print("[INFO] Device and 35 registers created on GATEWAY")
