...
Phase 4 reduces BLE MTU negotiation timeout from **40+ seconds to ~15 seconds**
through optimized timeout values and retry strategy.
...
- **Total worst case**: 3000 + 200 + 3000 + 400 + 3000 + 800 + 3000 =
  **13,400ms**
- **Actual observed**: **41,946ms** (MTU negotiation not responding for 40+
  seconds)
...
- **Rationale**: Longer single timeout (5s) but fewer retries (2 instead of 3) =
  faster total time

### 2. **BLEManager.cpp**

- **Line 966**: Reduced exponential backoff base delay from `200ms` to `100ms`
- **Rationale**: Faster retry intervals (100ms, 200ms instead of 200ms, 400ms,
  800ms)
