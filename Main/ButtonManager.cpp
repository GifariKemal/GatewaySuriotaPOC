...
ButtonManager::ButtonManager()
    : button(nullptr), buttonTaskHandle(nullptr),
      currentMode(MODE_RUNNING), productionMode(true),
      modeMutex(nullptr), bleManager(nullptr),
      lastStatusBlinkMillis(0), ledStatusState(LOW)
{
}
