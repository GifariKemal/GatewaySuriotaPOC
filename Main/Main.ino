...
#define FIRMWARE_VERSION "2.5.3" // v2.5.3: SSL Root CA update (GitHub switched to USERTrust/Sectigo)
...
void setup()
{
  ...
  if (otaManager)
  {
    ...
    otaManager->setCurrentVersion(FIRMWARE_VERSION, 2503); // Build number derived from version (2.5.3 = 2503)
