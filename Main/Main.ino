...
#define FIRMWARE_VERSION "2.5.4" // v2.5.4: Added USERTrust ECC trust anchor for github.com downloads
...
void setup()
{
  ...
  if (otaManager)
  {
    ...
    otaManager->setCurrentVersion(FIRMWARE_VERSION, 2504); // Build number derived from version (2.5.4 = 2504)
