...
#define FIRMWARE_VERSION "2.5.6" // v2.5.6: Fixed OTA download timeout for large files from CDN
...
void setup()
{
  ...
  if (otaManager)
  {
    ...
    otaManager->setCurrentVersion(FIRMWARE_VERSION, 2506); // Build number derived from version (2.5.6 = 2506)
