...
#define FIRMWARE_VERSION "2.5.5" // v2.5.5: Added HTTP redirect handling for GitHub releases CDN
...
void setup()
{
  ...
  if (otaManager)
  {
    ...
    otaManager->setCurrentVersion(FIRMWARE_VERSION, 2505); // Build number derived from version (2.5.5 = 2505)
