...
#define FIRMWARE_VERSION "2.5.27" // v2.5.27: Stable - Robust OTA with Resume & WDT Fixes
...
void setup()
{
  ...
  if (otaManager)
  {
    ...
    otaManager->setCurrentVersion(FIRMWARE_VERSION, 2527); // Build number derived from version (2.5.27 = 2527)
