...
#define FIRMWARE_VERSION "2.5.11" // v2.5.11: Fix private repo OTA (token embedded in URL)
...
void setup()
{
  ...
  if (otaManager)
  {
    ...
    otaManager->setCurrentVersion(FIRMWARE_VERSION, 2511); // Build number derived from version (2.5.11 = 2511)
