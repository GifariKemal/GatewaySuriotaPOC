...
#define FIRMWARE_VERSION "2.5.14" // v2.5.14: Fix private repo download (use GitHub API for assets)
...
void setup()
{
  ...
  if (otaManager)
  {
    ...
    otaManager->setCurrentVersion(FIRMWARE_VERSION, 2514); // Build number derived from version (2.5.14 = 2514)
