...
#define FIRMWARE_VERSION "2.5.7" // v2.5.7: Full SSL client reinit on redirect for clean memory allocation
...
void setup()
{
  ...
  if (otaManager)
  {
    ...
    otaManager->setCurrentVersion(FIRMWARE_VERSION, 2507); // Build number derived from version (2.5.7 = 2507)
