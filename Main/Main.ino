...
#define FIRMWARE_VERSION "2.5.8" // v2.5.8: Fix OTA state stuck on failure - now auto-resets to IDLE
...
void setup()
{
  ...
  if (otaManager)
  {
    ...
    otaManager->setCurrentVersion(FIRMWARE_VERSION, 2508); // Build number derived from version (2.5.8 = 2508)
