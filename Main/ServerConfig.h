...
struct ConfigValidationResult {
  ...
  ConfigValidationResult()
      : isValid(true), errorCode(500), message(""), field(""), suggestion("") {}

  ConfigValidationResult(bool valid, int code, const String& msg,
                         const String& fld = "", const String& sug = "")
      : isValid(valid),
        errorCode(code),
        message(msg),
        field(fld),
  ...
  // Helper for error
  static ConfigValidationResult error(int code, const String& msg,
                                      const String& field = "",
...
class ServerConfig {
 private:
  ...
  bool suppressRestart;  // Flag to suppress auto-restart (e.g., during factory
                         // reset)
 ...
 public:
  ...
  const ConfigValidationResult& getLastValidationResult() const {
