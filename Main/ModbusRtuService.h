...
private:
  ...
  // FIXED ISSUE #3: Helper function to eliminate code duplication in register logging (FC1/2/3/4)
  // Consolidates 80+ lines of duplicated unit processing, value formatting, and compact line building
