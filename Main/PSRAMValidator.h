 ...
 *
 * Provides pre-allocation validation, fragmentation prevention, and memory safety checks
 * for ESP32-S3 OPI PSRAM usage.
 *
 * Features:
...
public:
  ...
  bool canAllocateMultiple(const std::vector<size_t> &sizes, const char *component = "UNKNOWN");
