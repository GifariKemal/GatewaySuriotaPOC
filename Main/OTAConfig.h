 ...
 * @date 2025-12-12
 *
 * v2.5.35: Added FirmwareManifest struct (moved from OTAHttps.h to fix linker
 * errors)
 *
...
#define OTA_MAX_FIRMWARE_SIZE \
  (OTA_PARTITION_SIZE - 4096)  // Leave 4KB safety margin
...
#define OTA_DEFAULT_GITHUB_REPO "GatewaySuriotaOTA"
...
#define OTA_HTTPS_BUFFER_SIZE \
  32768  // Download buffer size (PSRAM) - 32KB for faster download
...
#define OTA_BLE_DATA_UUID \
  "0000FF02-0000-1000-8000-00805F9B34FB"  // Write No Response
...
struct FirmwareManifest {
  ...
  FirmwareManifest()
      : buildNumber(0), firmwareSize(0), mandatory(false), valid(false) {}
};

// ============================================
// CALLBACK TYPES
// ============================================
typedef void (*OTAProgressCallback)(uint8_t progress, size_t current,
                                    size_t total);
...
inline const char* getOTAErrorDescription(OTAError error) {
  switch (error) {
    case OTAError::NONE:
      return "No error";
    case OTAError::NETWORK_ERROR:
      return "Network unavailable";
    case OTAError::SERVER_ERROR:
      return "Server error";
    case OTAError::INVALID_URL:
      return "Invalid URL";
    case OTAError::INVALID_FIRMWARE:
      return "Invalid firmware format";
    case OTAError::SIGNATURE_FAILED:
      return "Signature verification failed";
    case OTAError::CHECKSUM_FAILED:
      return "Checksum verification failed";
    case OTAError::FLASH_ERROR:
      return "Flash write error";
    case OTAError::NOT_ENOUGH_SPACE:
      return "Not enough space";
    case OTAError::DOWNGRADE_REJECTED:
      return "Downgrade rejected";
    case OTAError::TIMEOUT:
      return "Operation timeout";
    case OTAError::ABORTED:
      return "Update aborted";
    case OTAError::ALREADY_UP_TO_DATE:
      return "Already up to date";
    case OTAError::MANIFEST_ERROR:
      return "Manifest parse error";
    case OTAError::GITHUB_AUTH_FAILED:
      return "GitHub authentication failed";
    case OTAError::PARTITION_ERROR:
      return "Partition error";
    case OTAError::ROLLBACK_REQUIRED:
      return "Rollback required";
    case OTAError::BLE_TRANSFER_ERROR:
      return "BLE transfer error";
    case OTAError::INVALID_STATE:
      return "Invalid state";
    case OTAError::MEMORY_ERROR:
 ...
 */
inline bool parseVersion(const char* version, uint8_t& major, uint8_t& minor,
                         uint8_t& patch) {
