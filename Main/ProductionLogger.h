...
enum class NetStatus : uint8_t { NONE, WIFI, ETHERNET };

// Protocol status
enum class ProtoStatus : uint8_t { OFF, CONNECTING, OK, ERROR };
...
class ProductionLogger {
 ...
 public:
  ...
  void logSystem(const char* event,
                 const char* detail = nullptr);            // System events
